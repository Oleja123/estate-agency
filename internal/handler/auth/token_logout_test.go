...
func (m *mockUserSvc) Register(ctx context.Context, req dto.RegisterRequest) (dto.PublicUser, error) {
	return dto.PublicUser{}, nil
}
func (m *mockUserSvc) Authenticate(ctx context.Context, req dto.LoginRequest) (dto.PublicUser, error) {
	return dto.PublicUser{}, nil
}
...
func (m *mockUserSvc) RefreshToken(ctx context.Context, refreshToken string) (dto.LoginResponse, error) {
	return dto.LoginResponse{}, nil
}
func (m *mockUserSvc) GetUserByID(ctx context.Context, userID int) (dto.PublicUser, error) {
	return dto.PublicUser{}, nil
}
func (m *mockUserSvc) UpdateProfile(ctx context.Context, req dto.UpdateProfileRequest) (dto.PublicUser, error) {
	return dto.PublicUser{}, nil
}
func (m *mockUserSvc) ChangePassword(ctx context.Context, userID int, req dto.ChangePasswordRequest) (dto.PublicUser, error) {
	return dto.PublicUser{}, nil
}
func (m *mockUserSvc) ChangePasswordAdmin(ctx context.Context, userID int, newPassword string) (dto.PublicUser, error) {
	return dto.PublicUser{}, nil
}
func (m *mockUserSvc) ToggleActiveAccount(ctx context.Context, userID int) (dto.PublicUser, error) {
	return dto.PublicUser{}, nil
}
func (m *mockUserSvc) ListUsers(ctx context.Context, req dto.ListUsersRequest) (dto.ListUsersResponse, error) {
